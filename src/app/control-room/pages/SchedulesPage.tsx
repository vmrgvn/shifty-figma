import { Archive, Copy, MoreHorizontal, Plus, Printer, Search, Settings2, Trash2 } from "lucide-react";
...
export function SchedulesPage({ schedules, onCreate, onOpen, onEdit, onPrint, onDuplicate, onArchive, onRemove }: Props) {
  ...
  return (
    <main className="cr-page"><div className="cr-page-limit">
      <div className="cr-heading-row"><div><h1>Расписания</h1><p>{schedules.length} расписаний · данные сохранены локально</p></div><button className="cr-primary" onClick={onCreate}><Plus size={15} /> Создать<span className="cr-desktop-only"> расписание</span></button></div>
